...
show_help() {
    ...
    echo ""
    echo "Usage:"
    echo "  curl -sSL https://raw.githubusercontent.com/${INSTALLER_REPO}/main/install.sh | bash"
    ...
    echo "  curl -sSL https://raw.githubusercontent.com/${INSTALLER_REPO}/main/install.sh | bash"
    echo "  curl -sSL https://raw.githubusercontent.com/${INSTALLER_REPO}/main/install.sh | bash -s -- --yes"
    echo ""
    echo "For users in China, use the China-optimized version:"
...
verify_git_repository() {
    ...
    # Accept both https and git@ formats, and also gitee mirrors
    local normalized_url="$remote_url"
    if [[ "$remote_url" == git@github.com:* ]]; then
        normalized_url="https://github.com/${remote_url#git@github.com:}"
    elif [[ "$remote_url" == https://gitee.com/* ]]; then
        # Accept gitee mirrors as valid
        normalized_url="https://github.com/${GITHUB_REPO}.git"
    fi
